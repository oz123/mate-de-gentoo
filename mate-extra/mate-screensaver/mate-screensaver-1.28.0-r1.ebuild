...
PATCHES=(
    "${FILESDIR}/0001-org.mate.ScreenSaver-org.freedesktop.ScreenSaver.patch"
	"${FILESDIR}/0001-Fix-mate-screensaver-may-not-respond-on-logind-dbus-.patch"
	"${FILESDIR}/0002-Migrate-mate-screensaver-command-to-org.freedesktop.patch"
)
